"""
Script for training stacked_cnn
"""
import os
...
delta = 1.0  # Threshold parameter for Huber Loss
huber_loss = tf.where(
...
decay_steps = 10000  # Decay every how many steps
decay_rate = 0.95  # Decay rate each time
