"""
Training script for fine-tuning stacked_cnn on real-world datasets
"""
import os
...
import driving_data
from model import build_stacked_cnn, build_finetune_stacked_cnn

pretrained_model = build_stacked_cnn(weights_path="./save/carla_original.ckpt")
finetune_model = build_finetune_stacked_cnn(pretrained_model)
LOGDIR = './save'
