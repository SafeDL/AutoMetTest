"""
Training script for fine-tuning cnn_gru on real-world datasets.
"""
import os
...
import driving_data
from model import build_conv_gru, build_finetune_model

# Build the fine-tuning model using pretrained weights
pretrained_model = build_conv_gru(weights_path="./save/carla_original.ckpt")
finetune_model = build_finetune_model(pretrained_model)
LOGDIR = './save'
sess = tf.InteractiveSession()
L2NormConst = 0.00001  # L2 regularization coefficient
